...
$sql = "INSERT INTO `messages` (`id`, `name`, `email`, `mobile`, `message`) VALUES (NULL, '$name', '$email', '$mobile', '$message')";
...
if (mysqli_query($conn, $sql)) {
    ...
    try {
        ...
        $mail->setFrom($emailSender, 'R-Support, R-GYM');
        $mail->addAddress($email, $name);
        $mail->addReplyTo($emailSender, 'Support R-GYM');

        // Email content
        $mail->isHTML(true);
        $mail->Subject = 'Thank You for Contacting R-GYM!';
            ...
            <body>
                <div id='container'>
                    <div id='header'>
                        ...
                        <p id='ceo'>From The Server Of R-GYM</p>
                    </div>
    ...
    header("Location: thankyoucon.html");
} else {
